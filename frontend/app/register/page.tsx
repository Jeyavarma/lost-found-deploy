            ...
            <div className="mb-8">
              ...
              <div className="flex justify-center space-x-8 mb-8">
                <div className={`flex items-center gap-2 ${currentStep >= 1 ? "text-[#1C13B3]" : "text-gray-400"}`}>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 1 ? "text-white" : "bg-gray-200"
                      }`}
                ...
                <div className={`flex items-center gap-2 ${currentStep >= 2 ? "text-[#1C13B3]" : "text-gray-400"}`}>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 2 ? "text-white" : "bg-gray-200"
                      }`}
                ...
                <div className={`flex items-center gap-2 ${currentStep >= 3 ? "text-[#1C13B3]" : "text-gray-400"}`}>
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center ${currentStep >= 3 ? "text-white" : "bg-gray-200"
                      }`}
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-12 h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-[#1C13B3] ${errors.name ? "border-red-500" : "border-gray-300"
                            }`}
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-12 h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-[#1C13B3] ${errors.email ? "border-red-500" : "border-gray-300"
                            }`}
                        />
                      </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-12 h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-[#1C13B3] ${errors.phone ? "border-red-500" : "border-gray-300"
                            }`}
                        />
                      </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.studentId ? "border-red-500" : "border-gray-300"
                          }`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.shift ? "border-red-500" : "border-gray-300"
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.department ? "border-red-500" : "border-gray-300"
                          }`}
                      >
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.year ? "border-red-500" : "border-gray-300"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-red-500 ${errors.password ? "border-red-500" : "border-gray-300"
                            }`}
                        />
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full h-12 border rounded-md px-3 text-base focus:outline-none focus:ring-2 focus:ring-red-500 ${errors.confirmPassword ? "border-red-500" : "border-gray-300"
                            }`}
                        />
                ...
                <div className="flex justify-between pt-8">
                  ...
                  {currentStep < 3 ? (
                    <button
                      type="button"
                      onClick={handleNext}
                      className={`ml-auto font-semibold px-8 py-2 rounded-md text-white transition-colors ${currentStep === 1 ? "hover:opacity-90" : "bg-green-600 hover:bg-green-700"
                        }`}
                      style={currentStep === 1 ? { backgroundColor: '#1C13B3' } : {}}
                    >
                      Continue
